...
// lint/rules.js imports the plugin API from vite-plus/lint/plugins, so no separate pin can drift.
assert.equal(packageJson.devDependencies["@oxlint/plugins"], undefined);
